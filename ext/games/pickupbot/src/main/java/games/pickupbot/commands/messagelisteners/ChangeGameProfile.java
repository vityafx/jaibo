...
public final class ChangeGameProfile extends Command implements MessageListener, ConfigurationListener {
    ...
    public ChangeGameProfile(ExtensionObject object) {
        this();
    ...
    public void configurationChanged() {
        ...
        String[] names = ExtensionObject.Configuration.get("commands.change_game_profile_binding").split(" ");
    ...
    protected void action() {
        try {
            ...
            this.object.getExtensionMessenger().sendNotice(this.receiver,
                    String.format("games.pickupbot.Game profile has been changed from [%s] to [%s]",
