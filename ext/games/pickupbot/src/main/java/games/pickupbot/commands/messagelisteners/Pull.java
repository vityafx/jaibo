...
/**
 * Removes player from the game by admin
...
public final class Pull extends Command implements MessageListener, ConfigurationListener {
    ...
    public Pull(ExtensionObject object) {
        this();
    ...
    public void configurationChanged() {
        ...
        String[] names = ExtensionObject.Configuration.get("commands.pull").split(" ");
    ...
    protected void action() {
        try {
            this.object.removePlayer(new Player(this.argument, null, null), this.gameType);

            if (ExtensionObject.Configuration.getBoolean("player.game_profile_required")) {
                this.object.removePlayer(new Player(null, null, this.argument), this.gameType);
            }
