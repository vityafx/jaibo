...
/**
 * Restart command allows core admins to restart the bot
...
public final class Restart extends Command implements MessageListener {
    private Object object;
    private IrcUser ircUser;

    public Restart() {
        this.addName("!restart");
    }

    public Restart(Object object) {
        this();
    ...
    protected void action() {
        this.object.getExtensionMessenger().sendPrivateMessage(this.ircUser.getNick(), "Bot is going to restart now");
