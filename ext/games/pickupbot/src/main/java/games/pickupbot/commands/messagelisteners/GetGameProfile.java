...
public final class GetGameProfile extends Command implements MessageListener, ConfigurationListener {
    ...
    public GetGameProfile(ExtensionObject object) {
        this();
    ...
    public void configurationChanged() {
        ...
        String[] names = ExtensionObject.Configuration.get("commands.get_game_profile_binding").split(" ");
    ...
    protected void action() {
        try  {
            String gameProfile = this.object.getGameProfile(this.host);
