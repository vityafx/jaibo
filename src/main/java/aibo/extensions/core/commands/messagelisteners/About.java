...
/**
 * About commands sends bot version, wiki, distribution links and etc
...
public final class About extends Command implements MessageListener {
    ...
    protected void action() {
        this.object.getExtensionMessenger().sendBroadcastMessage(this.object.getChannels(),
                AIBO.Configuration.get("aibo.about"));
    }
}