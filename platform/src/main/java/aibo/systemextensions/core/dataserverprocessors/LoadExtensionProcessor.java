...
/**
 * Load extension data server processor
...
public final class LoadExtensionProcessor extends DataServerProcessor {
    private Object extensionObject = null;

    public LoadExtensionProcessor(Object extensionObject) {
